...
const menuSections = [
  {
    ...
    items: [
      ...
      { href: '/plugins', label: 'プラグインマーケット', icon: 'M4 4h6v6H4V4zm0 10h6v6H4v-6zm10-10h6v6h-6V4zm3 10v6m-3-3h6' },
      { href: '/news', label: 'アップデートニュース', icon: 'M4 5h16v14H4V5zm4 4h8m-8 4h8m-8 3h4' },
